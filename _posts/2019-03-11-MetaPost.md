...
1.  点a和点b相距2cm, 在它们连线的 2/3 处，有一条线段，与ab成60度角，交点处要画一个半径 3pt 的圆圈。
    ...
    [![](/images/posts/markdown/ex1.png)](src/mp/example.mp)
    
2.  从线段外一点作它的平行线。想不到吧？这么简单的图，你最后发现无法用一个鼠标的工具完成！
    
    [![](/images/posts/markdown/ex2.png)](src/mp/example.mp)
    
3.  箭头ab，从圆圈 a 的中心出发，开始时向右，然后进入圆圈b的中心，进入时方向是向下的，箭头在圆圈内的部分不画出来。而圆圈 a 和 b 现在的位置还不能确定，需要根据其它圆圈的位置定位。
    
    [![](/images/posts/markdown/ex3.png)](src/mp/example.mp)
    
4.  这样的每个弧线只有几个参数有规律的变化的图片：
    
    [![](/images/posts/markdown/ex4.png)](src/mp/example.mp)
    
    不好办吧？点击以上4个图形就可以知道如何用 MetaPost 得到他们。注意这个短短的文件包含了所有这4个图形。再看看这些：
    
    ![](/images/posts/markdown/metapostexample_files/metapost_094.gif) ![](/images/posts/markdown/metapostexample_files/metapost_055.gif)![](/images/posts/markdown/metapostexample_files/metapost_200.gif)![](/images/posts/markdown/metapostexample_files/metapost_243.gif)![](/images/posts/markdown/metapostexample_files/metapost_260.gif)![](/images/posts/markdown/metapostexample_files/metapost_139.gif)![](/images/posts/markdown/metapostexample_files/metapost_248.gif)![](/images/posts/markdown/metapostexample_files/metapost_170.gif)
...
![](/images/posts/markdown/metapost-chinese.png)
...
![](/images/posts/markdown/countries.png)
...
![](/images/posts/markdown/graph1.png)![](/images/posts/markdown/graph2.png)![](/images/posts/markdown/graph3.png)![](/images/posts/markdown/graph4.png)
...
![](/images/posts/markdown/metapost-gnuplot.png)
...
2.  sarith 宏包
   ...
   `endfor;`
    ...
    ![](/images/posts/markdown/formatgrid.png)
...
![](/images/posts/markdown/piechart.gif)![](/images/posts/markdown/barchart.png)
...
3.  METAFONTbook [![](/images/posts/markdown/mfbk.jpeg)](http://sunburn.stanford.edu/~knuth/abcde.html#mfbk)
...
6.  [用MetaPost画Feynman图](http://heplix.ikp.physik.tu-darmstadt.de/~ohl/#computing)
    ...
    ![](/images/posts/markdown/feyn1.png)![](/images/posts/markdown/feyn2.png)![](/images/posts/markdown/feyn3.png)![](/images/posts/markdown/feyn4.png)
...
7.  [MetaGraf](http://w3.mecanica.upm.es/metapost/metagraf.php): 一个Java程序，可以“随手”画出 MetaPost 图形。这个程序可以弥补 MetaPost 的太精确的缺点，你可以用 MetaGraf 画出一些随手图形插到你的精确的文件里 :)
    ...
    ![](/images/posts/markdown/metagraf.png)
...
1.  我的本科毕业论文里的 Linux 内核 vfs 结构示意图：
    ...
    [![](/images/posts/markdown/vfs.png)](src/mp/vfs.mp)
    
2.  我上次作的有关串扰布线的报告里的图片。
    
    第一幅电路图的所有元件都是我自己设计的 MetaPost 宏产生的，我可以多次复用这些宏，而且可以随意制造自己需要的元件图。
    
    [![](/images/posts/markdown/circuit.png)](src/mp/circuit.mp)
    
    [![](/images/posts/markdown/bpi.png)](src/mp/bpi.mp)
    
    [![](/images/posts/markdown/mcregion.png)](src/mp/mcregion.mp)
    
    [![](/images/posts/markdown/flow.png)](src/mp/flow.mp)
    
    [![](/images/posts/markdown/exchange.png)](src/mp/exchange.mp)
    
3.  我的VLSI布图理论考试答案里的图片
    
    时延树  
    [![](/images/posts/markdown/tree.png)](src/mp/tree.mp)
    
    迷宫算法  
    [![](/images/posts/markdown/maze.png)](src/mp/maze.mp)
    
    steiner 树  
    [![](/images/posts/markdown/steiner.png)](src/mp/steiner.mp)
    
    最小生成树  
    [![](/images/posts/markdown/mst.png)](src/mp/mst.mp)
    
4.  我的计算几何作业里的图片
    
    [![](/images/posts/markdown/chain.png)](src/mp/chain.mp)
    
    [![](/images/posts/markdown/X.png)](src/mp/x.mp)
    
    [![](/images/posts/markdown/X1.png)](src/mp/x.mp)

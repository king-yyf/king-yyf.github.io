...
[neal's string_hash](https://github.com/nealwu/competitive-programming/blob/master/hash/string_hash.cc)
...
+ 给定字符串s，统计s是trie中多少个字符串的子串
+ 给定字符串s，对s的每个前缀串t， 统计t是trie中多少个字符串的子串，并对所有t求和
